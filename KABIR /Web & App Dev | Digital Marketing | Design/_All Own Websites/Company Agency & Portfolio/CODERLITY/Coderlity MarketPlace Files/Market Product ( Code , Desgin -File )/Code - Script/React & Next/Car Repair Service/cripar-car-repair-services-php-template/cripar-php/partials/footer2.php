            ...
            <div class="cs_footer_col">
              <div class="cs_footer_widget">
                ...
                <ul class="cs_footer_menu">
                  <li><a href="service-details.php">Adult In Car Lessons</a></li>
                  <li><a href="service-details.php">Defensive Driving</a></li>
                  <li><a href="service-details.php">Defensive Driving</a></li>
                  <li><a href="service-details.php">Initial driving lesson</a></li>
                  <li><a href="service-details.php">Woman Education</a></li>
                </ul>
              </div>
            </div>
            <div class="cs_footer_col">
                ...
                <ul class="cs_recent_post_widget">
                    ...
                    <div class="cs_recent_post">
                      ...
                      <div class="cs_recent_post_right">
                        <h3 class="cs_white_color cs_fs_16 cs_medium cs_mb_5">
                          <a href="blog-details.php">Your Car's Health, Our Priority</a>
                        </h3>
                  ...
                  <li>
                    <div class="cs_recent_post">
                      ...
                      <div class="cs_recent_post_right">
                        <h3 class="cs_white_color cs_fs_16 cs_medium cs_mb_5">
                          <a href="blog-details.php">The Tune-Up Your Car Deserves</a>
                        </h3>
                        <p class="cs_recent_posted_by cs_fs_14">
