            ...
            <div class="cs_card cs_style_1">
              ...
              <div class="cs_card_info cs_white_bg cs_radius_10 text-center">
                ...
                <h3 class="cs_card_title cs_fs_30 cs_mb_8">
                  <a href="service-details.php">Brake Safe Inspection</a>
                </h3>
                ...
                <a href="service-details.php" class="cs_text_btn cs_style_1 cs_bold cs_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="cs_card cs_style_1">
              ...
              <div class="cs_card_info cs_white_bg cs_radius_10 text-center">
                ...
                <h3 class="cs_card_title cs_fs_30 cs_mb_8">
                  <a href="service-details.php">Engine Tune-Up Plus</a>
                </h3>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="cs_card cs_style_1">
              ...
              <div class="cs_card_info cs_white_bg cs_radius_10 text-center">
                ...
                <h3 class="cs_card_title cs_fs_30 cs_mb_8">
                  <a href="service-details.php">Battery Boost Check</a>
                </h3>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="cs_card cs_style_1">
              ...
              <div class="cs_card_info cs_white_bg cs_radius_10 text-center">
                ...
                <h3 class="cs_card_title cs_fs_30 cs_mb_8">
                  <a href="service-details.php">Tune-Up Special Care</a>
                </h3>
          ...
          <div class="col-lg-4 col-md-6">
            <div class="cs_card cs_style_1">
              ...
              <div class="cs_card_info cs_white_bg cs_radius_10 text-center">
                ...
                <h3 class="cs_card_title cs_fs_30 cs_mb_8">
                  <a href="service-details.php">Suspension Alignment</a>
                </h3>
                <p class="cs_card_subtitle cs_mb_18">If your check battery light comes on it's best to schedule a diagnostic
                  service as soon as possible to identify address</p>
                <a href="service-details.php" class="cs_text_btn cs_style_1 cs_bold cs_heading_color">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="cs_card cs_style_1">
              ...
              <div class="cs_card_info cs_white_bg cs_radius_10 text-center">
                ...
                <h3 class="cs_card_title cs_fs_30 cs_mb_8">
                  <a href="service-details.php">Transmission Service</a>
                </h3>
                <p class="cs_card_subtitle cs_mb_18">Proper insulation and ventilation are key also offer Ice Guard services
                  to prevent ice buildup and damage If your check battery</p>
                <a href="service-details.php" class="cs_text_btn cs_style_1 cs_bold cs_heading_color">
              ...
              <div class="col-lg-4">
                <div class="cs_pricing_table cs_style_1">
                  ...
                  <div class="cs_pricing_info_wrapper">
                    ...
                    <a href="contact.php" class="cs_pricing_btn cs_fs_14 cs_bold cs_heading_color text-uppercase cs_radius_10">Choose Plan</a>
                  </div>
                </div>
              </div>
            </div>
